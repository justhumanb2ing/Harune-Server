			...
			api: [
				...
				},
				{
					...
					description: [
						...
						"- Media items may include `tempObjectKey` for temp-to-final promotion",
						"- Temp promotion validates ownership, requires `contentHash` and `contentType`, and best-effort deletes the temp object after copy",
						"- The response is a committed read of the saved profile graph and is `Cache-Control: no-store`",
					].join("\n"),
					tag: ["Profile API"],
				},
				{
