			...
			api: [
				{
					...
					description: [
						...
						"- `profilePage.imageCrop` stores the persisted crop rectangle for rendering the cropped profile image when provided",
						"",
						"Rules:",
						"- Requires a valid session",
				...
				},
				{
					...
					description: [
						...
						"- if no profile page exists, analytics is disabled, or the reporting provider is unavailable, the server returns `0`",
						"- `Cache-Control: no-store` is returned on successful responses",
						"- unexpected internal failures are mapped to `500` with the existing analytics error contract",
						"",
						"Example response:",
						"```json",
						"{",
			...
			api: [
				...
				},
				{
					...
					description: [
						...
						"- `imageCrop` is optional crop metadata that is stored as JSON when present",
				...
				},
				{
					...
					description: [
						...
						"- `page.imageCrop`: persisted crop rectangle for the profile image",
