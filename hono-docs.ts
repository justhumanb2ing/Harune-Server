			...
			api: [
				{
					...
					description: [
						...
						"- The response includes every stored column from `profile_page`, including `imageCrop` metadata for public rendering",
						"- Successful responses are returned with `Cache-Control: no-store`",
					].join("\n"),
					tag: ["Profile API"],
				},
				...
				},
				{
					...
					description: [
						...
						"Rules:",
						"- Requires a valid session",
						"- Accepts JSON with `imageKind`, `imageUrl`, and optional `imageCrop` metadata",
						"- `imageKind` must be `profile` or `background`",
						...
						"- When `imageCrop` is provided, it is committed with the same DB snapshot",
				...
				},
				{
					...
					description: [
						...
						"Rules:",
						"- Requires a valid session",
						"- Accepts JSON with any subset of `name`, `location`, `role`, `bio`, `image`, `imageCrop`, and `backgroundImage`",
						...
						"- `imageCrop` is stored as JSON metadata and is used by the shared cover renderer",
				...
				},
				{
					...
					description: [
						...
						"",
						"Response shape:",
						"- `page`: profile metadata such as handle, bio, hero image, and crop metadata",
